...
func Base(r *http.Request, data bool) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if strings.Contains(r.URL.Path, "/inbox/") {
			...
			templ_7745c5c3_Err = components.Inbox(user).Render(ctx, templ_7745c5c3_Buffer)
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		}
		if strings.Contains(r.URL.Path, "/chat-try") {
			...
			templ_7745c5c3_Err = components.ChatTry(auth, user, r).Render(ctx, templ_7745c5c3_Buffer)
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		}
		if strings.Contains(r.URL.Path, "/finder") {
			...
			templ_7745c5c3_Err = features.Finder(auth, user.Username, r).Render(ctx, templ_7745c5c3_Buffer)
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		}
		...
		if strings.Contains(r.URL.Path, "/profile/") {
			...
			if user.Username == usr.Username && user.Id == usr.Id {
				...
				templ_7745c5c3_Err = components.ElseProfile(*usr, r).Render(ctx, templ_7745c5c3_Buffer)
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
			}
		...
		if strings.Contains(r.URL.Path, "/requests/") {
			...
			templ_7745c5c3_Err = components.Requests(*user, auth, r).Render(ctx, templ_7745c5c3_Buffer)
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		}
		if r.URL.Path == "/" {
			templ_7745c5c3_Err = components.Navigation(data, r).Render(ctx, templ_7745c5c3_Buffer)
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
